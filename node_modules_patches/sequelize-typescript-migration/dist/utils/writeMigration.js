...
const removeCurrentRevisionMigrations_1 = require('./removeCurrentRevisionMigrations');

async function writeMigration(revision, migration, options) {
  await removeCurrentRevisionMigrations_1.default(revision, options.outDir, options);
  ...
  const template = `/* eslint-disable @typescript-eslint/no-var-requires */
